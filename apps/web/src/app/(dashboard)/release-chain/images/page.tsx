...
export default function ImagesPage() {
  ...
  async function pollNow(image: MonitoredImage) {
    ...
    try {
      await apiFetch("/modules/release-chain/images", {
        method: "POST",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
  ...
  async function removeImage(image: MonitoredImage) {
    ...
    try {
      if (image.id) {
        await apiFetch(`/modules/release-chain/images/${image.id}`, {
          method: "DELETE",
          credentials: "include",
        });
      }
